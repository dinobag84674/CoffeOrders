// Since this web app is only chrome compatible, we need to notify the user that they MUST use chrome.
...
BetterInnerHTML(document.querySelector("body"), "<h1>Please use Chrome (<a href=\"https://www.google.com/chrome/browser/\" target=\"_blank\">Download</a>), Thank You!</h1>");
